...
" Set python paths
let g:python_host_prog = expand('$HOME') . '/Documents/pyworks/envs/neovim2/bin/python'
let g:python3_host_prog = expand('$HOME') . '/Documents/pyworks/envs/neovim3/bin/python'
